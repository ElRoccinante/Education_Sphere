...
from education.models import User, Lesson
from flask import (
    render_template,
    url_for,
    flash,
...
from education.users.forms import (
    RegistrationForm,
    LoginForm,
    UpdateProfileForm,
    RequestResetForm,
...
from education import bcrypt, db
...
from education.users.helpers import send_reset_email
